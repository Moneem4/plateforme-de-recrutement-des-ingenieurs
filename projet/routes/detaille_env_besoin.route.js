...
const {
  ...
  detaille_long_besoinRoute.get("/:id_besoin/:id_environnement", getdetaille_long_besoinByIdController);
  ...
  detaille_long_besoinRoute.delete("/:id_besoin/:id_environnement", deletedetaille_long_besoinByIdController);
